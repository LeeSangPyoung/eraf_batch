...
class SchedulerJobServers(db.Model):
    ...
    def __init__(self, params):
        super().__init__(
            ...
            host_ip_addr=params.get("host_ip_addr"),
            secondary_host_ip_addr=params.get("secondary_host_ip_addr"),
            system_comments=params.get("system_comments"),
            queue_name=params.get("queue_name"),
            folder_path=params.get("folder_path"),
            secondary_folder_path=params.get("secondary_folder_path"),
