...
class Config(object):
    ...
    DEBUG_SQLALCHEMY = str(os.getenv("DEBUG_SQLALCHEMY")).lower() == "true"
    ENABLE_OTEL = str(os.getenv("ENABLE_OTEL")).lower() == "true"
    TESTING = False
    CSRF_ENABLED = True
...
config_dict = {"Production": ProductionConfig, "Debug": DevelopmentConfig}
