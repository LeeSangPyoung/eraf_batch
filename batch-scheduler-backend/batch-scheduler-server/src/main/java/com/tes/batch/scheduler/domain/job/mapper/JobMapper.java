...
public interface JobMapper {
    ...
    /**
     * Find restartable jobs that missed their schedule during server downtime.
     * Conditions:
     * - restartable = true
     * - workflow_id IS NULL (not part of a workflow)
     * - is_enabled = true
     * - next_run_date < now (missed the schedule)
