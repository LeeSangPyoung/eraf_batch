...
-- Job Group table
CREATE TABLE IF NOT EXISTS scheduler_job_group (
...
-- Job Server table
CREATE TABLE IF NOT EXISTS scheduler_job_server (
...
CREATE TABLE IF NOT EXISTS scheduler_jobs (
    ...
    system_id VARCHAR(36) REFERENCES scheduler_job_server(system_id),
    group_id VARCHAR(36) REFERENCES scheduler_job_group(group_id),
...
-- Job Run Log table
CREATE TABLE IF NOT EXISTS scheduler_job_run_log (
    id VARCHAR(36) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS scheduler_related_group_user (
    ...
    group_id VARCHAR(36) REFERENCES scheduler_job_group(group_id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_job_run_log_job_id ON scheduler_job_run_log(job_id);
CREATE INDEX IF NOT EXISTS idx_job_run_log_start_time ON scheduler_job_run_log(start_time);
